...
Тестовое задание для на позицию «Программист на языке C++»
...
Примечание по заданию: Не обязательно все размещать в одном классе. Может быть разработана иерархия классов. Чем более функционален интерфейс класса, тем лучше. Желательно использовать как можно больший спектр возможностей языка. Желательно чтобы оформление кода было приближено к оформлению промышленного кода.
